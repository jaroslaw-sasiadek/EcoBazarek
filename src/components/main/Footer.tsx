...
export const Footer = () => (
	<footer className="flex flex-col items-center z-40 w-full mt-auto bg-[--c1] text-[--c5]">
		...
		<section className="flex items-center gap-[40px] h-[62px]">
			...
			<a
				...
				aria-label="pogadaj z nami na twitterze"
			>
			...
			<a
				...
				aria-label="zobacz nas na youtube'ie"
			>
